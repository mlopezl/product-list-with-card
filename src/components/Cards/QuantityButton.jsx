...
function QuantityButton({quantity, addQuantity, subtractQuantity, addToCart, name}) {
  return (
    <button className="absolute w-35 h-10 rounded-3xl -bottom-5 left-18 bg-Red text-Rose-50 flex justify-between items-center p-3 pl-4 pr-4 border-1 border-Rose-500 z-1">
      ...
      <IncrementButton increaseQuantity={addQuantity} addToCart={addToCart} name={name}/>
    </button>
  );
}
